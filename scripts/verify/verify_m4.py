...
COVERAGE: dict = {
    ...
    "A1-03 item 入包默认绑定（count 默认/显式 bound=false）": "pytest:test_reward.py::test_tc15_item_into_inventory_default_bound + test_reward.py::test_item_default_count_and_explicit_bound_false + test_reward.py::test_item_id_alias_npc_give_item + test_reward.py::test_item_no_add_hook_applied_false",
