...
COVERAGE: dict = {
    ...
    "3.3-05 完成即移出 + 主线进度累计（2026-09-05 语义：主线完成不再常驻板）+ 双板仲裁": "pytest:test_quest.py::test_complete_removes_active_counts_daily_tc21 + test_quest.py::test_complete_main_progress_and_hidden_after_tc22 + test_quest.py::test_board_main_pinned_ordering_tc24 + test_quest.py::test_board_active_marker_tc25 + test_quest.py::test_board_zone_excluded + test_quest.py::test_board_weekly_event_slots + test_quest.py::test_resolve_board_index",
...
_MODULES: dict = {
    ...
    "condition_engine": "qbot_rpg.core.condition_engine",
