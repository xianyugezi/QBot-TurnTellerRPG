...
# ---------------------------------------------------------------------------
# GM 指令全集（14 条 G1-G14 名，5b §2.1 总表；批30 删 G13「编辑」→ 13 条）：判定用白名单——
# has_permission 只认本集内的 command 名，集外一律 False（防任意串注入授权表）
GM_COMMANDS_ALL: FrozenSet[str] = frozenset({
    # G1-G14（契约 §2.1 L85-104）；批30（2026-09-16）G13 编辑已删
