...
九期215 战报五新 key（battle_stage_shift_line / battle_windup_unknown /
battle_windup_ready / battle_merge_summary / battle_mention_line，cloudsea-pack
合并已迁入 template_table.json 全量表，占位符白名单由表自动派生）：渲染零
emoji 铁律对既有键不变；其中 ◈/❓/🌀/▫ 系 D-01 内容包 emoji 白名单登记位
（content/cloudsea 装配时经本模块注册/校验）。
"""
